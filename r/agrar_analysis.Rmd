...
Most of the non-institutional beneficiaries are Hungarian citizens. It would be interesting to see the gender-based distribution of the subsidies given to people. This information is not in the data but we can split citizens to male/female categories based on their names. This will not be 100% accurate but the data does not allow a better approach. All given names legally allowed in Hungary are available on the [internet](http://www.nytud.mta.hu/oszt/nyelvmuvelo/utonevek/). Names not in the list are of foreign origin so they show up as 'unknown'. Some female citizens changed their legal name to that of their husbands by adding a "-né" postfix. This pattern is easy to find so I took this into account.
...
Fixing the addresses was the most complicated part of the data engineering pipeline. There are 3 fields that contain address information: zip code, settlement and the address.
